...
<script language="javascript" type="text/javascript">
    $(document).ready(function () {
        var serviceURL = '/Teachers/GetStudentsAlreadyinClassData'; //This should not be inside AJAX call itself
...
<div class="row">
    ...
    <div class="col-sm-3" style="background-color:#fff;margin-top:50px;position:absolute;padding:5px;width:500px;">
        <div style="margin-left:25px;">
            <h3 style="text-align:center;">REMOVE STUDENT FROM CLASS</h3>
            <br /><br />
                    ...
                    <tr id="trStudents">
                        <td>
                           @* @Html.LabelFor(Function(model) model.StudentsList, htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})*@
                            @Html.Label("SELECT STUDENT TO REMOVE FROM CLASS:", htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                        </td>
                        <td>
