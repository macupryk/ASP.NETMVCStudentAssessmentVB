@Code
    ViewData("Title") = "AssignToTeachers"
End Code
...
<div class="row">
    ...
    <div class="col-sm-3" style="background-color:#fff;margin-top:50px;position:absolute;padding:5px;">
        <div style="margin-left:25px;">
            <h3 style="text-align:center;">ASSIGN CLASS TO TEACHER</h3>
            <br /><br />
                ...
                @<table id="tblCreateClass" border="0" cellpadding="2" cellspacing="2" style="margin-top:-40px;">
                    ...
                    <tr>
                        <td colspan="2" style="text-align:center;">
                            <input type="submit" value="ASSIGN CLASS TO TEACHER" class="btn btn-success" />
